...
def extract_first_frame_jpeg(source: str, output_path: str, seek: float = 0.0) -> bool:
    ...
    source poster picks the highest-rated clip's timestamp here). Returns True on
