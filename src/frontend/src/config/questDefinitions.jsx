...
export const STEP_DESCRIPTIONS = {
  ...
  export_overlay: <>Click each <GreenSquare /> green square on the timeline, then click on your player in the video if you can. If not, move the ellipse around your player and size it manually. When done, click <MiniButton>Add Overlay</MiniButton>.</>,
  ...
  overlay_second_highlight: <>Click each <GreenSquare /> green square on the timeline, then click on your player in the video if you can. If not, move the ellipse around your player and size it manually. When done, click <MiniButton>Add Overlay</MiniButton>.</>,
  ...
  overlay_reel: <>Click each <GreenSquare /> green square on the timeline, then click on your player in the video if you can. If not, move the ellipse around your player and size it manually. When done, click <MiniButton>Add Overlay</MiniButton>.</>,
