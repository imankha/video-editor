...
ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    ...
    <ReportProblemButton className="fixed bottom-20 right-4 z-[9999] bg-gray-800/90 border border-gray-600 rounded-lg px-3 py-2 text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 shadow-lg transition-colors" />
  </React.StrictMode>,
)
