 ...
 * 3 frames = ~5px gap — tight but clickable. At 30fps, 3 frames = 100ms.
 * Previously 10 frames (333ms) which blocked keyframes on clips under 3s.
 */
export const MIN_KEYFRAME_SPACING = 3;
