      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <Section id="information-we-collect" title="1. Information We Collect">
          ...
          <ul className="list-disc pl-5 space-y-1 mb-4">
            ...
            <li><strong className="text-white">Athlete Intro Card data:</strong> A player photo, the player&apos;s name, and short display facts (position, graduation year/class, team) plus any free text you type onto an Athlete Intro Card, along with a parental-consent attestation recorded when you first create a card. No birthdate, age, address, or school is collected.</li>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>No birthdate, age, address, or school for players featured in Athlete Intro Cards</li>
        ...
        <Section id="childrens-privacy" title="6. Children's Privacy (COPPA)">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong className="text-white">Athlete Intro Cards are parent-created and consent-gated.</strong> You provide the photo, name, and display facts (position, graduation year, team); we record your parent/guardian consent before the first card and collect no birthdate, age, address, or school. A shared card is publicly visible to anyone with the link.</li>
          </ul>
          <p className="mt-3"><strong className="text-white">Parental rights:</strong> Parents/guardians who have uploaded video or created Athlete Intro Cards for their children retain full control. All Athlete Intro Card data (photo, parent-typed facts, and consent record) is included in a data export and erased when you delete the card or your account.</p>
