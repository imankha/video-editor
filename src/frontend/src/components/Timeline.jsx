...
export function Timeline({
  ...
  return (
    <div className="timeline-container py-4">
      <div
        ref={timelineRef}
        className="relative h-12 bg-gray-700 rounded-lg cursor-pointer select-none"
      ...
      >
        {/* Progress bar */}
        <div
          className="absolute top-0 left-0 h-full bg-blue-600 rounded-lg transition-all pointer-events-none"
