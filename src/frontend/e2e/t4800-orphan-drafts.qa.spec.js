 ...
 *   criterion-2: deleting C's clip PRESERVES the published reel in Published (downloads).
 */
...
test('clip-delete drops the exported auto-reel draft (root cause) and keeps published reels', async ({ page }) => {
  ...
  // Published reel survives in Published (downloads), independent of its source clip.
