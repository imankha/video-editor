...
**Follows:** [T6610](T6610-overlay-text-element-manipulation.md) (built the body drag), [T5225](player-intro/T5225-overlay-text-layer.md) (built the lane)
**Related:** [T6590](T6590-preview-marker-linkage-and-playhead-occlusion.md) (same lane, occlusion)
