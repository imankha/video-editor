...
| — | [T6480](T6480-overlay-text-editor-contrast.md) — Overlay text editor contrast | T5225's follow-up: the Edit Text rail read bright-on-bright on Overlay's own light panel. Fixed host-side, shared component untouched. Merged 2780032d. |
| — | [T6520](T6520-card-slot-size-align-overrides.md) — Per-slot size/align overrides | CLOSED, superseded 2026-08-10. Proposed reintroducing size/alignment as overrides on top of the shared geometry contract; reversed by decision 12 (T6640) two days after being decided — the template owns typography for cards by design, and T6640 removed the mechanisms this task depended on. |
