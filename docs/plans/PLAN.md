...
| T1960 | [Migrate Global SQLite to Upstash Redis](tasks/for-launch/T1960-migrate-auth-to-fly-postgres.md) | 8 | 6 | 1.3 | TODO | [ ] | Move auth.sqlite + sharing.sqlite to Upstash Redis on Fly. Eliminates restart fragility, concurrent write contention, and O(users) R2 syncs. Gates alpha exit. |
