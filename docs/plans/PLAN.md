...
| T3100 | ↳ [Extract useVideoProxy](tasks/VIDEO-PROXY-EPIC.md#t3100-extract-usevideoproxy-from-usemultivideoscrub) | 9 | 5 | P1 | TESTING | [ ] | Create useVideoProxy hook: video-element management, ping-pong swap, cross-boundary seek, error handling, videoController interface. |
