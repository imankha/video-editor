...
| T840 | [Annotate Drag/Play Conflict](tasks/T840-annotate-drag-play-conflict.md) | TESTING | 7 | 3 | Dragging start/end time handles while video is playing causes playback to fight with drag preview |
