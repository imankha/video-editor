...
| T2480 | [Modal Spline Interpolation](tasks/T2480-modal-spline-interpolation.md) | 3 | 2 | 1.5 | TODO | [ ] | Modal `_interpolate_crop` still uses linear; inline Catmull-Rom spline helpers to match editor preview (WYSIWYG consistency) |
