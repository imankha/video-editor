...
| T2540 | ↳ [Verify HTTP/2 on Fly.io Edge](tasks/page-load-optimization/T2540-verify-http2-fly-edge.md) | 6 | 2 | P1 | TODO | [ ] | 40-60ms TLS overhead per new connection. Verify h2 negotiation, enable if missing. |
