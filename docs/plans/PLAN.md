...
| | **[Athlete Profile Epic](tasks/athlete-profile/EPIC.md)** | 6 | 5 | 1.2 | | | **Profile stores athlete name, team name, sport. Sport drives annotation tags. Tags are user-editable; 6 supported sports + custom.** |
| T1610 | ↳ [Profile Fields](tasks/athlete-profile/T1610-profile-fields.md) | 6 | 3 | 2.0 | TODO | [x] | DB schema: athlete_name, team_name, sport (free-text, not enum) + combobox UI with 6 supported sports + custom entry. (Absorbs T1073) |
| T1620 | ↳ [Sport-Specific Tag Definitions](tasks/athlete-profile/T1620-sport-specific-tag-definitions.md) | 6 | 4 | 1.5 | TODO | [ ] | sport_tags DB table + seed data for Soccer, Flag Football, American Football, Basketball, Lacrosse, Rugby. Tags seeded on first sport selection. |
| T1625 | ↳ [Custom Tag Editing](tasks/athlete-profile/T1625-custom-tag-editing.md) | 6 | 5 | 1.2 | TODO | [ ] | CRUD UI for tags: add/edit/remove tags and position groups for any sport. Reset-to-defaults for supported sports. |
| T1630 | ↳ [Sport-Driven Tag Selection](tasks/athlete-profile/T1630-sport-driven-tag-selection.md) | 7 | 5 | 1.4 | TODO | [ ] | Annotation UI loads tags from API by sport. Custom sports with no tags show clean UI (no tags/positions, no errors). |
