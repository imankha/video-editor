...
| T630 | [Startup Request Optimization](tasks/T630-startup-optimization.md) | TESTING | Parallelize post-auth fetches, dedup /games calls, gate achievements, combine auth endpoints |
