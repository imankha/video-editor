...
| T252 | [E2E Project Manager Default Tab](tasks/T252-e2e-project-manager-default-tab.md) | TESTING | 3 | 1 | Test expects Projects tab but UI defaults to Games; blocks 8 downstream tests |
