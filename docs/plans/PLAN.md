...
| T4947 | ↳ [Cache stitched downloads](tasks/collection-download/T4947-cache-stitched-downloads.md) | 5 | 2 | 2.5 | STAGING | [ ] | Disposable R2 cache keyed by member-set hash (no DB row, no migration). Credit-recharge-exemption half of the original scope is moot (downloads are free, Decision 4). Depends on T4946. Merged 2026-08-15. |
