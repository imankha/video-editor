...
| T580 | [Can't Reframe — Shows Exported Video](tasks/T580-reframing-shows-exported-video.md) | TESTING | 7 | 4 | Fix: reset shared videoStore on mode switch + useLayoutEffect guard in FramingScreen |
