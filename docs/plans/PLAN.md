...
| T2530 | ↳ [Index Export Jobs Unacknowledged](tasks/page-load-optimization/T2530-index-export-jobs-unacknowledged.md) | 7 | 1 | P0 | TODO | [ ] | 487ms server wait on /exports/unacknowledged — no index on acknowledged_at or completed_at. Add composite index. |
