...
| T11170 | ↳ [Welcome credits no longer depend on quests](tasks/quest-removal/T11170-welcome-credits-decouple.md) | 8 | 2 | 4.0 | WIP | [ ] | Never rename `quest_upfront` / `questbank:` or every account is paid again. Fresh signup must still end at the advertised total. |
