...
| T2460 | ↳ [Pending Status Recovery](tasks/auto-export-reliability/T2460-pending-status-recovery.md) | 8 | 1 | 8.0 | TESTING | [ ] | Reset stale `pending` auto_export_status on startup so crashed exports retry |
| T2450 | ↳ [Presigned URL for FFmpeg](tasks/auto-export-reliability/T2450-auto-export-presigned-url.md) | 7 | 3 | 2.3 | TESTING | [ ] | Pass presigned R2 URL to FFmpeg instead of downloading full 3GB game video. Same pattern as T1220. |
| T2470 | ↳ [Sweep Keepalive](tasks/auto-export-reliability/T2470-sweep-keepalive.md) | 5 | 2 | 2.5 | TESTING | [ ] | Ping localhost health during active sweep to prevent Fly.io auto-suspend |
...
| T2420 | ↳ [Annotations + Highlights Tabs](tasks/expired-game-experience/T2420-annotations-highlights-tabs.md) | 6 | 4 | 1.5 | TESTING | [ ] | Two video modes: all annotated clips, or just 5-star highlights |
| T2430 | ↳ [Brilliant Clips in My Reels](tasks/expired-game-experience/T2430-brilliant-clips-in-my-reels.md) | 6 | 2 | 3.0 | TESTING | [ ] | Ensure auto-exported 5-star clips are filterable and always accessible in My Reels |
...
| T2480 | [Modal Spline Interpolation](tasks/T2480-modal-spline-interpolation.md) | 3 | 2 | 1.5 | TESTING | [ ] | Modal `_interpolate_crop` still uses linear; inline Catmull-Rom spline helpers to match editor preview (WYSIWYG consistency) |
