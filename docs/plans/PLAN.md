...
| ID | Task | Status | Pri | Description |
|----|------|--------|-----|-------------|
| T1360 | [Blob URL Error Recovery](tasks/video-load-reliability/T1360-blob-url-error-recovery.md) | TESTING | 4.0 | Stale blob URL auto-recovers to streaming URL; no misleading "Video format not supported" overlay |
