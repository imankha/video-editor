...
| T1400 | [Video Load Contention](tasks/video-load-reliability/T1400-video-load-contention.md) | TESTING | 4.5 | Narrowed post-T1410: range-fallback watchdog + `[VIDEO_LOAD]` structured logs for prod measurement |
...
| T1430 | [Range Overbuffer (2151s for 8s clip)](tasks/video-load-reliability/T1430-range-overbuffer.md) | TODO | 1.5 | Browser buffers ~2151s for an 8s clip despite `#t=` fragment; investigate Content-Range behavior |
