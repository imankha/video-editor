...
| T10930 | [Annotate timeline zoom in/out with a visible control, desktop and mobile](tasks/T10930-annotate-timeline-zoom-controls.md) | 7 | 4 | 1.8 | WAITING ON USER | [ ] | User request 2026-09-21. Decision artifact https://claude.ai/artifact/VRztYxsiraMJz6wsMrUENB (shared with T10890's span-bar half). Recommended: a `-  N%  +` chip on desktop AND phone rendered by TimelineBase (Focus/Overlay get it too), wheel stays on desktop, scroll pill stays on phone, phone opens at 300% instead of being pinned there; no pinch (T10780 reason stands). Awaiting the pick. |
