...
| T5225 | ↳ [Overlay text layer](tasks/player-intro/T5225-overlay-text-layer.md) | 7 | 6 | 1.2 | WIP | [ ] | Off-wave - needs only T5180, so it runs early. Timeline text layer + clip-boundary snapping + burn-in in BOTH render loops. Design approved 2026-08-04 (6 answers recorded in the handoff). Modal redeploy is the user's step and is still pending. |
