...
| T2500 | [Veo Link Import](tasks/for-alpha/T2500-veo-link-import.md) | 8 | 4 | 2.0 | TODO | [ ] | Paste a Veo match URL in Add Game dialog → backend fetches full-quality MP4 from Veo CDN (no auth needed). Eliminates download+re-upload friction for ~2/3 of users. |
