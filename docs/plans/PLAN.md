...
| T760 | [Background Local Processing](tasks/T760-background-local-processing.md) | TESTING | 7 | 4 | Local exports block the web server; return 202 immediately and run GPU work in background task |
