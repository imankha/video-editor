...
| T11200 | ↳ [Read-only census of multi-clip drafts and reels (all envs)](tasks/single-clip-editor/T11200-multiclip-data-census.md) | 7 | 3 | 2.3 | WIP | [ ] | Counts drive R3. Walks every profile DB from R2 read-only, plus archive JSON and Postgres share tokens. |
