...
|------|------|------|------|------|------|------|------|
| T5140 | [Reshoot Tutorial Videos (carousel/poster UI + Team layer; slow narration baked in, 1x playback)](tasks/T5140-reshoot-tutorial-videos.md) | 7 | 4 | 1.8 | STAGING | [ ] | All 4 quests reshot against current UI from ReelBallersTutroials (Phase A); all 12 assets verified live on R2 (verify_assets.py green, 2026-08-17). Phase B (DEFAULT_RATE 0.8 -> 1 in TutorialVideoModal.jsx + landing TutorialModal.tsx) landed on master 2026-08-17, auto-deploying staging. |
