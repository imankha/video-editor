...
**Now unblocked — the "after the reshoot" group is ready to start:** [T7020](tasks/T7020-game-video-faststart-remux.md) (user-ordered 2026-08-15) is FIRST — see its row above for why it's deliberately held rather than shipped as-is. Then the [JIT Migration epic](tasks/jit-migration/EPIC.md) (T5081-T5089, user-ordered 2026-08-04) — not a UI-runway member, placed immediately after T5140 and ahead of Tile Video Preview. [Collection Download](tasks/collection-download/EPIC.md) (above) is complete already. Relative order between JIT Migration and Tile Video Preview not yet specified by the user. **The [SEO Content & Landing Value Props epic](tasks/seo-content/EPIC.md) is NOT part of this group** — per the Priority Policy (growth work sits behind infrastructure bugs) it is sequenced after Milestone TOP finishes entirely, not merely after the reshoot; see the SEO & Organic Discovery section below.

|  | **[Tile Video Preview](tasks/tile-video-preview/EPIC.md)** | 6 | 4 | 1.5 |  |  | Design settled 2026-08-03, filed as a fully-specced epic but never given a PLAN.md row until 2026-08-10 (found untracked while researching a user request — was previously only mentioned in prose above). Draft/reel tiles play their video inline (muted, looping, in place) on glance instead of a static poster — desktop hover, touch in-viewport autoplay, both against YouTube/Netflix prior art (design authority table in EPIC.md). Was deliberately placed AFTER the T5140 reshoot (user decision, now shipped 2026-08-17) so recordings weren't invalidated by a feature simply absent from them — no longer blocked. Not started. |
