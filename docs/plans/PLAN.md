...
| T2855 | ↳ [Shared Game Storage Extension](tasks/team-sharing-alpha/T2855-shared-game-storage-extension.md) | 6 | 2 | 3.0 | TODO | [ ] | Verify + fix recipients can extend storage on shared games independently. No upload cost, just extension credits. |
