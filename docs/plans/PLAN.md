...
| T2660 | [Remove Dead useGameUpload.upload()](tasks/T2660-remove-dead-useGameUpload-upload.md) | 2 | 1 | 2.0 | TODO | [ ] | Dead upload path in useGameUpload — all uploads go through uploadStore. Remove upload()/cancel() methods, unused state, and dead tests. |
