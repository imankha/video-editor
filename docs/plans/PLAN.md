...
| T250 | [Clip Store Unification](tasks/T250-clip-store-unification.md) | TODO | 5 | 4 | Eliminate dual-store sync: merge useProjectClips into Zustand, compute flags, use backend IDs |
