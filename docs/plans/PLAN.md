...
| T3080 | [Sync User Activity to SQLite](tasks/T3080-sqlite-user-activity.md) | 6 | 3 | 2.0 | TESTING | [x] | Dual-write user activity (session counts, event counts, last_active_at) to per-user SQLite alongside Postgres for fast per-user reads |
