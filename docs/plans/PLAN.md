...
| T1533 | [Overlay Working Video Slow First-Load](tasks/T1533-overlay-working-video-slow-load.md) | 7 | 3 | 2.0 | TODO | 15s metadata timeout on multi-clip overlay open; browser range-walks 20MB. Likely moov atom not at head despite `+faststart` with `-c copy` on multipart upload |
