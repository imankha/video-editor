...
| | **[Video Proxy Layer](tasks/VIDEO-PROXY-EPIC.md)** | 9 | 8 | P1 | | | Virtualize N video files behind a single controller. Fixes bug p4. |
...
| T3110 | ↳ [Migrate useMultiVideoScrub](tasks/VIDEO-PROXY-EPIC.md#t3110-migrate-usemultivideoscrub-to-consume-usevideoproxy) | 7 | 4 | P1 | TODO | [ ] | Refactor useMultiVideoScrub to delegate video management to useVideoProxy; keep RAF loop + navigation. |
| T3120 | ↳ [Migrate useAnnotationPlayback](tasks/VIDEO-PROXY-EPIC.md#t3120-migrate-useannotationplayback-to-consume-usevideoproxy) | 8 | 5 | P1 | TODO | [ ] | Refactor useAnnotationPlayback to use proxy. Structurally fixes bug p4 (pause-all + seeked waiting). |
| T3130 | ↳ [Migrate PlaybackControls](tasks/VIDEO-PROXY-EPIC.md#t3130-migrate-playbackcontrols-to-use-videocontroller) | 4 | 2 | P1 | TODO | [ ] | Replace raw ref volume/mute in PlaybackControls + RecapPlayerModal with controller. |
| T3140 | ↳ [Remove singleVideoController](tasks/VIDEO-PROXY-EPIC.md#t3140-remove-singlevideocontroller-from-annotatescreen) | 5 | 2 | P1 | TODO | [ ] | Remove ad-hoc singleVideoController; proxy handles both modes. |
| T3150 | ↳ [Consolidate effective* wrappers](tasks/VIDEO-PROXY-EPIC.md#t3150-consolidate-effective-wrappers-in-annotatecontainer) | 5 | 3 | P1 | TODO | [ ] | Remove effectiveSeek/effectiveTogglePlay/etc wrappers from AnnotateContainer. |
...
| T3230 | [Auto-Materialize Pending Shares](tasks/T3230-auto-materialize-pending-shares.md) | 9 | 3 | P0 | TESTING | [ ] | Pending teammate shares never resolve unless recipient clicks exact share link. Auto-materialize in user_session_init() for single-profile users on login/signup. |
