...
| T2680 | [Remove Video Link Import](tasks/T2680-remove-video-link-import.md) | 9 | 3 | 3.0 | TESTING | [x] | Remove all Veo/Trace link import code (T2600-T2635). Legal risk: ToS violation, CFAA, no DMCA safe harbor. Adopt CapCut liability profile -- user-upload only. |
...
| T1620 | ↳ [Sport-Specific Tag Definitions](tasks/athlete-profile/T1620-sport-specific-tag-definitions.md) | 6 | 3 | 2.0 | TESTING | [ ] | Static tag definition files for Flag Football, American Football, Basketball, Lacrosse, Rugby. Register in tagRegistry.js. |
| T1630 | ↳ [Sport-Driven Tag Selection](tasks/athlete-profile/T1630-sport-driven-tag-selection.md) | 7 | 4 | 1.8 | TESTING | [ ] | Annotation UI reads sport from profile and loads tags from tagRegistry. Custom sports with no tags show clean UI. |
