...
| T127 | [R2 Database Restore on Startup](tasks/deployment/T127-r2-database-restore-on-startup.md) | TODO | Restore SQLite from R2 on cold start to prevent data loss |
| T128 | [WebSocket Reconnection Resilience](tasks/deployment/T128-websocket-reconnection-resilience.md) | TODO | Exponential backoff reconnect for Fly.io auto-stop disconnects |
