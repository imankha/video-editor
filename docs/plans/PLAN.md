...
| T2510 | ↳ [Store Fetch Dedup Guards](tasks/page-load-optimization/T2510-store-fetch-dedup-guards.md) | 5 | 2 | P0 | TODO | [ ] | creditStore.fetchCredits() and authStore.checkAdmin() lack _fetchPromise dedup. Add module-level promise guard matching other stores. |
