...
| T750 | [R2 Retry Resilience](tasks/T750-r2-retry-resilience.md) | TESTING | 8 | 5 | Add retry with exponential backoff to all R2 operations; transient network failures currently cause immediate 500s |
