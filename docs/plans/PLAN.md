...
| T1620 | ↳ [Sport-Specific Tag Definitions](tasks/athlete-profile/T1620-sport-specific-tag-definitions.md) | 6 | 3 | 2.0 | TODO | [ ] | Static tag definition files for Flag Football, American Football, Basketball, Lacrosse, Rugby. Register in tagRegistry.js. |
| T1630 | ↳ [Sport-Driven Tag Selection](tasks/athlete-profile/T1630-sport-driven-tag-selection.md) | 7 | 4 | 1.8 | TODO | [ ] | Annotation UI reads sport from profile and loads tags from tagRegistry. Custom sports with no tags show clean UI. |
