...
| T2625 | ↳ [Modal Video Ingest](tasks/video-import/T2625-modal-video-ingest.md) | 9 | 4 | 2.3 | TODO | [ ] | Move ffmpeg remux + blake3 + R2 upload off Fly.io to Modal. Unified `ingest_video_to_r2()` handles both direct (Veo) and HLS (Trace). Eliminates R2 CopyObject. |
