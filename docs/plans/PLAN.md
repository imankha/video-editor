...
| T1180 | [Export Guard Null video_filename](tasks/T1180-export-guard-null-video-filename.md) | TODO | 2.0 | Export crashes with `games/None.mp4` ffprobe error when game has NULL video_filename. Pre-flight reject with 400, no credit reserve |
