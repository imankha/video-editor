...
| T5205 | ↳ [Card editor UI](tasks/player-intro/T5205-card-editor-ui.md) | 8 | 6 | 1.3 | TODO | [ ] | Wave 3. Library grid + editor stage + per-slot text controls + browser motion preview. The first screen where a card can actually be built, so it is the epic's first real payoff. Reuses the shared TextSpecEditor that T5225 defines. Depends on T5195. |
