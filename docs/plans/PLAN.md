...
| T2520 | ↳ [Parallelize Export Recovery Fetches](tasks/page-load-optimization/T2520-parallelize-export-recovery-fetches.md) | 6 | 2 | P0 | TODO | [ ] | useExportRecovery chains exports/active → exports/unacknowledged sequentially. Fire both in parallel with Promise.allSettled. |
